...
public class Et extends Formule {
	...
	protected Formule entrerNegations() { 
		return new Et(this.formuleGauche.entrerNegations(),this.formuleDroite.entrerNegations());
	}
	...
	public ListeClauses clauses() throws NotFNCException, TrueClauseException, FalseClauseException, VariableClauseException {
		...
		clauses.addAll(this.formuleGauche.clauses());
		clauses.addAll(this.formuleDroite.clauses());
		return clauses;
	}
}
